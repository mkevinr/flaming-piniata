<?php
  ...
  if(array_key_exists('delivery_latitude', $_REQUEST) > 0){
    ...
    $sql = "SELECT guild_esl FROM GUILDS WHERE flower_shop_id=" . $_SESSION['flower_shop_id'];
	...
	header("Location: https://" . $server_address . "/lab4/flower_shops/flower_shop_profile?flower_shop_id=" . $_SESSION['flower_shop_id']);
  }
  
  print("<p><b>Delivery request:</b></p>");
  print("<form action=\"https://" . $server_address . "/lab4/flower_shops/request_delivery.php?flower_shop_id=" . $_SESSION['flower_shop_id']
		. "\" method=\"POST\">");
?>
