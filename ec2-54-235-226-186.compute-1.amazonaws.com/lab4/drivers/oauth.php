<?php
  ...
  if(strlen($_REQUEST['code']) <= 0){
	...
	$redirect_location = "Location: https://foursquare.com/oauth2/authenticate?"
			...
			. "https://" . $server_address . "/lab4/drivers/oauth.php";
    ...
    . "&redirect_uri=https://" . $server_address . "/lab4/drivers/oauth.php"
    . "&code=" . $_REQUEST['code']);
    ...
    header("Location: https://" . $server_address . "/lab4/drivers/create_account.php?oauth=finished");
  }
